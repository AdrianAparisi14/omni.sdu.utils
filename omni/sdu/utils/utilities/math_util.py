...
def get_transform_as_ur_pose_rotvec(transform):
    """_summary_
    ...
    T_base_tcp_out_pq = pt.pq_from_transform(transform)
    T_base_tcp_out_pos = T_base_tcp_out_pq[0:3]
    T_base_tcp_out_quat = np.array([T_base_tcp_out_pq[4], T_base_tcp_out_pq[5], T_base_tcp_out_pq[6], T_base_tcp_out_pq[3]])
    T_base_tcp_out_rotvec = R.from_quat(T_base_tcp_out_quat)
    # return np.concatenate((T_base_tcp_out_pos, T_base_tcp_out_rotvec.as_euler('xyz')))
    # T_base_tcp_out_rotvec = r.quat_to_euler_angles(T_base_tcp_out_pq[3:7])
    # return np.concatenate((T_base_tcp_out_pos, T_base_tcp_out_rotvec))
    return np.concatenate((T_base_tcp_out_pos, T_base_tcp_out_rotvec.as_rotvec()))
...
def get_pose_as_transform(transform):
    r = pr.quaternion_from_matrix(transform[1])
    pq = np.hstack((transform[0], r))
    T_base_tcp = pt.transform_from_pq(pq)
    return T_base_tcp
